...
public class Dialogueforchicken : MonoBehaviour
{
    //Fields
    //Window
    ...
    public Sprite eggSprite; // Add this line if you have a spri
    private void Awake()
    {
    ...
    private void Update()
    {
        ...
        if(waitForNext && Input.GetKeyDown(KeyCode.Q))
        {
            ...
            if(index >= 0 && index != 1)
            {
                inventoryManager.AddItem("egg", 1, eggSprite);
                Debug.Log("egg added to inventory");
            }
